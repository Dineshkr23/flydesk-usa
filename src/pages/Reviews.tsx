  ...
  const reviews: Review[] = [
    {
      ...
      title: "Excellent service and great prices!",
              content: "I booked a last-minute flight to Paris and Fly Desk Usa found me an amazing deal. The booking process was smooth, and customer service was incredibly helpful when I had questions about my itinerary. Highly recommend!",
      date: "2024-12-15",
      helpful: 24,
      verified: true,
      tripType: "Leisure",
      destination: "Paris, France",
      avatar: "https://plus.unsplash.com/premium_photo-1661266851970-7f2bf75fdc40?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8Y29ycG9yYXRlJTIwd29tZW58ZW58MHx8MHx8fDA%3D"
    },
    {
      id: "2",
      author: "Michael Chen",
    ...
    },
    {
      ...
      title: "Amazing customer support!",
              content: "When my flight was cancelled due to weather, Fly Desk Usa's customer service team went above and beyond to help me find an alternative. They were patient, professional, and found me a better flight option. Outstanding service!",
      date: "2024-12-08",
      helpful: 31,
      verified: true,
      tripType: "Leisure",
    ...
    },
    {
      ...
      title: "Best flight booking experience ever!",
              content: "I've used many travel sites, but Fly Desk Usa is by far the best. The search filters are intuitive, prices are unbeatable, and the booking confirmation came instantly. Plus, their travel insurance options are comprehensive and affordable.",
      date: "2024-12-03",
      helpful: 28,
      verified: true,
      tripType: "Leisure",
    ...
    },
    {
      ...
      title: "Reliable and trustworthy",
              content: "Booked multiple flights through Fly Desk Usa and never had any issues. The website is reliable, prices are fair, and customer service is responsive. Would definitely recommend to friends and family.",
      date: "2024-11-30",
      helpful: 15,
      verified: true,
      tripType: "Business",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            See what our customers have to say about their travel experiences with Fly Desk Usa. 
        ...
        {showReviewForm && (
          <Card className="mb-8 border-blue-200">
            <CardHeader>
              ...
              <CardDescription>
                Share your travel experience with Fly Desk Usa
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="bg-blue-50 border-blue-200">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-700 mb-4 italic">
                  "Fly Desk Usa made booking my dream vacation so easy. The prices were unbeatable and the customer service was exceptional."
                </p>
            ...
            <Card className="bg-green-50 border-green-200">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-700 mb-4 italic">
                  "I've used many travel sites, but Fly Desk Usa consistently offers the best deals and most reliable service."
                </p>
                <div className="flex items-center gap-2">
                  <div className="flex">
                    {renderStars(5)}
        ...
        <Card className="mt-12 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
          <CardContent className="pt-6 text-center">
            ...
            <p className="text-blue-100 mb-6">
              Join thousands of satisfied customers who trust Fly Desk Usa for their travel needs.
            </p>
