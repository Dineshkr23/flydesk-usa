  ...
  const teamMembers: TeamMember[] = [
    {
      ...
      image: "https://plus.unsplash.com/premium_photo-1661266851970-7f2bf75fdc40?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8Y29ycG9yYXRlJTIwd29tZW58ZW58MHx8MHx8fDA%3D",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Founded in 2009, Fly Desk Usa began as a small startup with a big dream: to make travel 
            ...
            <div className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl p-8 text-white">
              <h3 className="text-2xl font-bold mb-4">Why Choose Fly Desk Usa?</h3>
          ...
          <CardContent>
            <div className="grid md:grid-cols-3 gap-6 text-center">
              ...
              <div className="flex flex-col items-center">
                ...
                <a href="mailto:support@flydeskusa.com" className="text-gray-300 hover:text-white transition-colors hover:underline">support@flydeskusa.com</a>
              </div>
              <div className="flex flex-col items-center">
                <MapPin className="w-6 h-6 mb-2 text-blue-400" />
                <h4 className="font-semibold mb-1">Address</h4>
                <p className="text-gray-300">2484 Field Spring Dr, Lithonia, GA, 30058, USA</p>
              </div>
            </div>
          </CardContent>
        </Card>
