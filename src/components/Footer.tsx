    ...
    <footer className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900 text-white overflow-hidden" id="contact">
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center justify-center mb-6" style={{ width: '200px' }}>
              <img src={logo} alt="Brand Logo" className="w-full h-auto max-h-32 object-contain rounded-xl" style={{ filter: 'brightness(0) invert(1)' }} />
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li><Link to="/disclaimer" className="hover:text-white transition-all duration-300 hover:translate-x-1 inline-block">Disclaimer</Link></li>
              <li><Link to="/refund-policy" className="hover:text-white transition-all duration-300 hover:translate-x-1 inline-block">Refund Policy</Link></li>
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-300">
              <div className="flex items-center space-x-3 group">
                ...
                <a href="tel:18773325780" className="group-hover:text-white transition-colors">1877-332-5780</a>
              </div>
              <div className="flex items-center space-x-3 group">
                ...
                <a href="mailto:support@flydeskusa.com" className="group-hover:text-white transition-colors hover:underline">support@flydeskusa.com</a>
              </div>
              <div className="flex items-center space-x-3 group">
                ...
                <span className="group-hover:text-white transition-colors">2484 Field Spring Dr, Lithonia, GA, 30058, USA</span>
              </div>
            </div>
          </div>
        </div>
