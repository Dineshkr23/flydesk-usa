...
const Header = () => {
  ...
  return (
    <header className={`${scrolled ? "bg-white" : "bg-white/10 backdrop-blur-md"} border-b border-white/20 sticky top-0 z-50 shadow-lg transition-colors duration-300`}>
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          <Link to="/" className="flex items-center space-x-3 group">
            <div className=" h-10  flex items-center justify-center  transition-all duration-300 p-0">
